...
| limux-upstream-20260702-005 | runtime-isolation | test | high | upstream issue #106 | direct | 5 | 2 | 2 | Use "running Limux twice breaks first socket" as a pending regression case for stable/preview isolation. | Create/link follow-up runtime smoke task. |
