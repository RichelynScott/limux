...
2. **PR #138** (`dame/renderer-tick-overlap-20260812`, `76c0f4f` + `45351ec` + `227fe58` + `b05b05a`): fixed the 100 ms hidden-tick overlap with the 8 ms visible frame timer (~10 ticks/s), and added aggregate timer-vs-wakeup counters through health output. The timer counter combines 8 ms + 100 ms timer calls; the remaining ~85/s delta is unattributed pending live measurement. The combined-tree wrapper test passed all 497 host tests; this is not live validation.
